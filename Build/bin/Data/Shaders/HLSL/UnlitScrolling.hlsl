...
uniform float2 cScrollDirection;
uniform float cScrollSpeed;
    ...
    out float4 oColor : OUTCOLOR0)
{
    ...
    #ifdef DIFFMAP
        float4 diffColor = cMatDiffColor * Sample2D(DiffMap, iTexCoord + cScrollDirection * cScrollSpeed * cElapsedTimePS);
        #ifdef ALPHAMASK
            if (diffColor.a < 0.5)
                discard;
        #endif
